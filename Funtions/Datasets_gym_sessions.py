...
dataset_gym_sessions = "dbfs:/portafolio/datasets/gym_sessions"
spark.conf.set(f"dataset.gymsessions", dataset_gym_sessions)

# COMMAND ----------

download_dataset(data_source_uri, dataset_gym_sessions)
